...
- [x] **T001** [P] Write `tests/unit/test_pytest_plugin.py` (uses `pytester`,
...
- [x] **T002** Implement `src/intui/pytest_plugin.py`: `pytest_addoption`
